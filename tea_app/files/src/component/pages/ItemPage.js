...
class ItemPage extends React.Component{
    ...
    mapToCerti(certis){
        ...
        return <MiniCard uuid={index} background={"url(http://localhost:5000/img/hill2.jpg)"} head={<h1 style={{color: Color.white, letterSpacing: "0.3rem"}}>{item.name}</h1>} title={<h5 style={{color: Color.white}}>檢驗合格</h5>} min_width={"10rem"} mask={"rgba(0, 0, 0, 0.3)"}/>
        })
    }
