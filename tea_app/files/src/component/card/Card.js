...
class Card extends React.Component {
    ...
    render(){
        return (
            ...
            //         this.state.title,
            //         this.state.subtitle, 
            //         this.state.horizontal_align,
            //         this.state.vertical_align,
            //         this.state.min_height,
            //         this.state.min_width
            //     )}
            // </div>
            // <div key={i} style={{margin: "1rem", backgroundColor: Color.blueDark, borderRadius: "20px", display: "inline-block", boxShadow: "5px 5px 20px grey", minHeight: "5rem", minWidth: "20rem"}}>
            <div key={this.state.uuid} style={{display: "inline-block", margin: "1rem"}} href={this.state.link}>
                <div style={{display: "table", background: this.props.background, backgroundPosition: "center", backgroundSize: "cover", backgroundRepeat: "no-repeat", boxShadow: "5px 5px 20px grey", minWidth: this.state.min_width, minHeight: this.state.min_height, borderRadius: "20px", display: "inline-block", opacity: this.state.opacity}}>
                    <div style={{display: "table-cell", tableLayout: "fixed"}}>
                        <div style={{minWidth: this.state.min_width, minHeight: this.state.min_height, verticalAlign: this.state.vertical_align, textAlign: this.state.horizontal_align, padding: "3rem", backgroundColor: this.state.mask, borderRadius: "20px", fontFamily: font_style.fontFamily}}>
                                <div style={{}}>
                                    {this.state.top}
                                    {/* <img src={Facebook}></img> */}
                                    {this.state.head}
