        ...
        <div>
            ...
            <div class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active" style={{backgroundImage: "url("+ props.cover_img +")", height: "100vh", minHeight: "350px"}}>
                        <div style={{width: "100%", height: "100%", textAlign: "left", backgroundColor: "rgba(0,0,0,0.5)"}}>
                            <div style={{position: "absolute", top: "50%", transform: "translateY(-50%)", marginLeft: "3rem", marginRight: "3rem"}}>
                                <h1 class="display-4" style={title_style}>{props.title}</h1>
                                <h3 class="lead" style={subtitle_style}>{props.subtitle}</h3>
