...
function insertOrder(buyer_name, phone, email, bank_code, bank_account, country, province, county, township, village, road, items, total_price, total_quantity, block_id, block_link, transaction_id, agree_policy, agree_promotion, is_paid, is_send, is_recieved, comment) {
    ...
    Util.checkBool(is_send, 'DbOrder.insertOrder re_is_send')
    ...
    ${ds.dataStructure.order.is_recieved.key},
    row_to_json(${ds.dataStructure.order.comment.key}) AS ${ds.dataStructure.order.comment.key})
        VALUES('${buyer_name}', '${phone}', '${email}', '${bank_code}', '${bank_account}', '${country}', '${province}', '${county}', '${township}', 
        '${village}', '${road}', ARRAY(SELECT json_populate_record(null::OrderItem, json_array_elements('${JSON.stringify(items)}'))), 
        '${total_price}', '${total_quantity}', ${block_id}, ${block_link}, ${transaction_id}, '${agree_policy}', '${agree_promotion}', '${is_paid}', '${is_send}', '${is_recieved}', ${comment}
...
// queryOrdersCountAll()
for(let i=0; i<4; i++){
    insertOrder("Da", "Taiwan", "Taiwan", "Nantou", "LuGu", "FongHuang", "indus.rd", "Universal Best Tea", "# Best Tea Ever", sections, items, "order1.jpg", undefined)
    insertOrder("Ui", "Taiwan", "Taiwan", "Nantou", "LuGu", "FongHuang", "indus.rd", "Universal Best Tea", "# Best Tea Ever", sections, items, "order1.jpg", imgs)
    insertOrder("Dai3", "Taiwan", "Taiwan", "Nantou", "Lu/Gu", "FongHuang", "indus.rd", "Universal Best Tea", "# Best Tea Ever", sections, items, "order1.jpg", imgs)
}
// queryOrderById(1)
...
exports.creatOrderItemType = creatOrderItemType;
